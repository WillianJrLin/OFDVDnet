...
class modUNET(nn.Module):
    ...
    def forward(self, fl_0, wl_0, cm_0, fl_1, wl_1, cm_1, fl_2, wl_2, cm_2):
        
        ## input        
        x_0 =  torch.cat((fl_0, wl_0, cm_0, fl_1, wl_1, cm_1, fl_2, wl_2, cm_2), dim=1)
...
class unetTREE(nn.Module):    
    ...
    def forward(self, fluorescent_frames, whiteLight_frames, counts_maps):
        
        # tree level 0
        #print("dimenson of unetTREE level_0 input: ", fluorescent_frames.shape, whiteLight_frames.shape, counts_maps.shape)   
        ...
        (cm_frame_0, cm_frame_1, cm_frame_2, cm_frame_3, cm_frame_4) = tuple(counts_maps[:, m:m+1, :, :] for m in range(self.num_inputs_tree))
        
        frame_20 = self.treeLevel_0(frame_0, wl_frame_0, cm_frame_0, frame_1, wl_frame_1, cm_frame_1, frame_2, wl_frame_2, cm_frame_2)
        frame_21 = self.treeLevel_0(frame_1, wl_frame_1, cm_frame_1, frame_2, wl_frame_2, cm_frame_2, frame_3, wl_frame_3, cm_frame_3)
        frame_22 = self.treeLevel_0(frame_2, wl_frame_2, cm_frame_2, frame_3, wl_frame_3, cm_frame_3, frame_4, wl_frame_4, cm_frame_4)
        
        #print("dimenson of unetTREE level_0 output: ", frame_20.shape, frame_21.shape, frame_22.shape)   
        
        # tree level 1
        frame_out = self.treeLevel_1(frame_20, wl_frame_1, cm_frame_1, frame_21, wl_frame_2, cm_frame_2, frame_22, wl_frame_3, cm_frame_3)
