...
class modUNET(nn.Module):
    ...
    def forward(self, fl_0, cm_0, fl_1, cm_1, fl_2, cm_2):
        
        ## input        
        x_0 =  torch.cat((fl_0, cm_0, fl_1, cm_1, fl_2, cm_2), dim=1)
...
class unetTREE(nn.Module):    
    ...
    def forward(self, fluorescent_frames, counts_maps):
        
        # tree level 0
        #print("dimenson of unetTREE level_0 input: ", fluorescent_frames.shape, counts_maps.shape)   
        ...
        frame_20 = self.treeLevel_0(frame_0, cm_frame_0, frame_1, cm_frame_1, frame_2, cm_frame_2)
        frame_21 = self.treeLevel_0(frame_1, cm_frame_1, frame_2, cm_frame_2, frame_3, cm_frame_3)
        frame_22 = self.treeLevel_0(frame_2, cm_frame_2, frame_3, cm_frame_3, frame_4, cm_frame_4)
        
        #print("dimenson of unetTREE level_0 output: ", frame_20.shape, frame_21.shape, frame_22.shape)   
        
        # tree level 1
        frame_out = self.treeLevel_1(frame_20, cm_frame_1, frame_21, cm_frame_2, frame_22, cm_frame_3)
